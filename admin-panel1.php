            ...
            <div class="tab-content" id="nav-tabContent">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="dashboard-card">
                                ...
                                <h4>Doctor List</h4>
                                <a href="#list-doc" onclick="clickTab('#list-doc-list')">View Doctors</a>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="dashboard-card">
                                ...
                                <h4>Patient List</h4>
                                <a href="#list-pat" onclick="clickTab('#list-pat-list')">View Patients</a>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="dashboard-card">
                                ...
                                <a href="#list-app" onclick="clickTab('#list-app-list')">View Appointments</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="dashboard-card">
                                ...
                                <a href="#list-pres" onclick="clickTab('#list-pres-list')">View Prescriptions</a>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="dashboard-card">
                                <div class="card-icon"><i class="fa fa-stethoscope"></i></div>
                                <h4>Manage Doctors</h4>
                                <a href="#list-settings" onclick="clickTab('#list-adoc-list')">Add</a>
                                &nbsp;|&nbsp;
                                <a href="#list-settings1" onclick="clickTab('#list-ddoc-list')">Delete</a>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="dashboard-card">
                                ...
                                <a href="#list-mes" onclick="clickTab('#list-mes-list')">View Queries</a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="tab-pane fade" id="list-doc" role="tabpanel">
                    ...
                    <div class="col-md-8 mb-3">
                        <form action="doctorsearch.php" method="post">
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <input type="submit" name="doctor_search_submit"
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            <?php
                            $doctorListResult = mysqli_query($databaseConnection, "SELECT * FROM doctb");
                ...
                <div class="tab-pane fade" id="list-pat" role="tabpanel">
                    ...
                    <div class="col-md-8 mb-3">
                        <form action="patientsearch.php" method="post">
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <input type="submit" name="patient_search_submit"
                                           class="btn btn-primary" value="Search"/>
                                </div>
                            </div>
                        </form>
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            <?php
                            $patientListResult = mysqli_query($databaseConnection, "SELECT * FROM patreg");
                ...
                <div class="tab-pane fade" id="list-app" role="tabpanel">
                    ...
                    <div class="col-md-8 mb-3">
                        <form action="appsearch.php" method="post">
                            <div class="row">
                                <div class="col-md-10">
                                    <input type="text" name="app_contact"
                                           placeholder="Search by Contact"
                                           class="form-control"/>
                                </div>
                                <div class="col-md-2">
                                    <input type="submit" name="app_search_submit"
                                           class="btn btn-primary" value="Search"/>
                                </div>
                            </div>
                        </form>
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            <?php
                            $appointmentResult = mysqli_query($databaseConnection, "SELECT * FROM appointmenttb");
                ...
                <div class="tab-pane fade" id="list-pres" role="tabpanel">
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            <?php
                            $prescriptionResult = mysqli_query($databaseConnection, "SELECT * FROM prestb");
                ...
                <div class="tab-pane fade" id="list-settings" role="tabpanel">
                    ...
                    <form method="post" action="admin-panel1.php" style="max-width:600px;">
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" class="form-control" name="dpassword"
                                   id="dpassword" placeholder="Enter password"
                                   onkeyup="checkPasswordMatch();" required/>
                        </div>
                        <div class="form-group">
                            <label>Confirm Password</label>
                            <input type="password" class="form-control" name="cdpassword"
                                   id="cdpassword" placeholder="Confirm password"
                                   onkeyup="checkPasswordMatch();" required/>
                ...
                <div class="tab-pane fade" id="list-settings1" role="tabpanel">
                    ...
                    <form method="post" action="admin-panel1.php" style="max-width:600px;">
                        <div class="form-group">
                            ...
                            <input type="email" class="form-control" name="demail"
                                   placeholder="Enter doctor email to delete" required/>
                        </div>
                        <button type="submit" name="docsub1" class="btn btn-danger"
                ...
                <div class="tab-pane fade" id="list-mes" role="tabpanel">
                    ...
                    <div class="col-md-8 mb-3">
                        <form action="messearch.php" method="post">
                            <div class="row">
                                <div class="col-md-10">
                                    <input type="text" name="mes_contact"
                                           placeholder="Search by Contact"
                                           class="form-control"/>
                                </div>
                                <div class="col-md-2">
                                    <input type="submit" name="mes_search_submit"
                                           class="btn btn-primary" value="Search"/>
                                </div>
                            </div>
                        </form>
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            <?php
                            $queriesResult = mysqli_query($databaseConnection, "SELECT * FROM contact");
                    ...
                    <div style="overflow-x:auto;">
                        <table class="table table-hover table-bordered amb-table">
                            ...
                            while ($amb = mysqli_fetch_assoc($ambResult)) {
                                ...
                                $bookedAt = date('d M Y, h:i A', strtotime($amb['booked_at']));
